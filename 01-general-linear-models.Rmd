...
```{r 1-ca-explore, fig.height = 5, fig.cap="Calcium concentration (mg/dl) by age and gender"}
...
```{r 1-ca-m1, fig.height= 5, fig.cap="Graphical representation of model m1"}
